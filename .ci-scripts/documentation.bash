...
BUILD_DIR="build/valbytes-docs"
DOCS_DIR="${GEN_MD}/valbytes/${TAG}"
...
branch_name="valbytes-${TAG}"
git checkout -b "${branch_name}"
echo "Adding content..."
git add .
git commit -m "Add docs for package: valbytes version: ${TAG}"
